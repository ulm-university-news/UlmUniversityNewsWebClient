 ...
 */
public class LoadMyAccountEditAction implements Action {
    /** An instance of the Logger class which performs logging for the LoadMyAccountEditAction class. */
    private static final Logger logger = LoggerFactory.getLogger(LoadMyAccountEditAction.class);

    /**
     * This method executes the business logic to show editable account information of the logged in moderator.
     *
    ...
    public String execute(RequestContextManager requestContext) throws SessionIsExpiredException, ServerException {
        ...
        if (activeModerator == null) {
                ...
                return Constants.MY_ACCOUNT_EDIT_LOAD_FAILED;
        }

        return Constants.MY_ACCOUNT_EDIT_LOADED;
    }
