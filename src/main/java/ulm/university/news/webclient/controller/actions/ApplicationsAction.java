...
public class ApplicationsAction implements Action {
    ...
    /**
     * This method executes the business logic to edit (accept/decline) applications (moderator resources) from the
     * server.
     *
    ...
    public String execute(RequestContextManager requestContext) throws SessionIsExpiredException, ServerException {
        logger.debug("In ApplicationsAction");
        ...
        if (currentModerator != null) {
            ...
            try {
                ...
                requestContext.storeInSession("applicationEditError", errorMessage);
